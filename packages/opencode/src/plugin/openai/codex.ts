...
<html>
  <head>
    <title>DreamCode - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to DreamCode.</p>
    </div>
    <script>
...
<html>
  <head>
    <title>DreamCode - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
