...
const MANAGED_PLIST_DOMAIN = "ai.dreamcode.managed"
...
function systemManagedConfigDir(): string {
  switch (process.platform) {
    case "darwin":
      return "/Library/Application Support/dreamcode"
    case "win32":
      return path.join(process.env.ProgramData || "C:\\ProgramData", "dreamcode")
    default:
      return "/etc/dreamcode"
  }
}
