...
PATTERN_RULES = [
    ...
    (r'\b(react|jsx|tsx|component|hooks?)\b', "frontend", "low"),
    ...
    (r'\b(document|documentation|readme|doc|docs)\b', "communication", "low"),
...
def build_chain(tasks: list[dict], complexity: str) -> list[str]:
    ...
    task_chain_map = {
        ...
        "python": ["neuro", "python", "testing"],
        "frontend": ["neuro", "frontend", "testing"],
        "frontend": ["neuro", "frontend", "testing"],
        "quantum": ["neuro", "quantum", "performance"],
        "data": ["neuro", "data", "testing"],
        "planning": ["neuro", "planning", "architecture"],
        "architecture": ["neuro", "architecture", "code-hardener"],
        "product": ["neuro", "product", "planning"],
        "communication": ["neuro", "communication", "communication"],
        "communication": ["neuro", "communication"],
        "research": ["neuro", "research", "communication"],
        "onboarding": ["neuro", "onboarding", "communication"],
        "automation": ["neuro", "automation", "testing"],
