export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by DreamCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in DreamCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "DreamCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "dreamcode.ai/zen",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in DreamCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in DreamCode.",
  ...
  "dialog.server.description": "Switch which DreamCode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "DreamCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking DreamCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking DreamCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating DreamCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating DreamCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update DreamCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update DreamCode",
  "wsl.onboarding.opencodeReadyIn": "DreamCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "DreamCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install DreamCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install DreamCode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen DreamCode.",
  ...
  "toast.update.description": "A new version of DreamCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the DreamCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, DreamCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "DreamCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "DreamCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the DreamCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for DreamCode",
  ...
  "settings.general.row.appearance.description": "Customise how DreamCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether DreamCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how DreamCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when DreamCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of DreamCode.",
