# DreamCode Documentation

This directory contains detailed documentation for specific DreamCode features.
...
- **[GUIDE.md](../GUIDE.md)** — Full walkthrough of every feature
